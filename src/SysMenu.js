...
var SysMenu = cc.Layer.extend({
    ...
    init:function () {
        ...
        if (this._super()) {
            ...
            sp.setPosition(cc.p(winSize.width / 2 - sp._rect.size.width/2, 0));
            this.addChild(sp, 0, 1);

            var logo = cc.Sprite.create(s_cocos2d);
            console.log(s_cocos2d,logo)
            logo.setAnchorPoint(cc.p(0, 0));
            //logo.setPosition(cc.p(screenWidth/4, 250));
            logo.setPosition(cc.p(winSize.width / 2 - logo._rect.size.width/2, 250));
            ...
            var tmp = cc.TextureCache.getInstance().addImage(s_ball);
    ...
    onNewGame:function (pSender) {
        ...
        //scene.addChild(PhysicsDemoLayer.create());
        scene.addChild(StickGameLayer.create());
